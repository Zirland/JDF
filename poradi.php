...
if ($odd == 1) {
    $query7 = "SELECT trip_id,stop_id,arrival_time FROM stoptime WHERE trip_id='$trip_id' ORDER BY arrival_time,zastav_id;";
}
if ($odd == 0) {
    $query7 = "SELECT trip_id,stop_id,arrival_time FROM stoptime WHERE trip_id='$trip_id' ORDER BY arrival_time,zastav_id DESC;";
}
