...
echo "<form method=\"post\" action=\"station.php\" name=\"filtr2\">";
echo "<input name=\"action\" value=\"filtr2\" type=\"hidden\">";
...
switch ($action) {
    case "filtr2":
        ...
        $query28     = "SELECT route_short_name FROM route WHERE route_id IN (SELECT SUBSTRING(trip_id, 1, 7) FROM stoptime WHERE stop_id = '$filtr2') ORDER BY route_short_name;";
        ...
        echo "<a href=\"stopedit.php?id=$filtr2\" target=\"_blank\">Editace zastávky</a>";
        echo "<hr>";
