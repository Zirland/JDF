...
<th></th>";
echo "</tr>";
$query = "SELECT route_id, agency_id, route_short_name, route_long_name, route_desc, route_type, route_url, route_color, route_text_color, active FROM route WHERE active=0 ORDER BY route_short_name";
