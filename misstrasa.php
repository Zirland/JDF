...
$query0 = "SELECT stop_id, stop_name, stop_code, pomcode FROM `stop` WHERE stop_id IN (SELECT DISTINCT stop1 FROM du WHERE final = '0') ORDER BY stop_name;";
...
switch ($action) {
    ...
    case "kam":
        ...
        <?php
        echo "<form method=\"post\" action=\"misstrasa.php\" name=\"uloz\">
